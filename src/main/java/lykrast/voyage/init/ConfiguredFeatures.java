...
public class ConfiguredFeatures {
	...
	public static ConfiguredFeature<?, ?> ROCK_BOULDERS = register("rock_boulders", Feature.RANDOM_SELECTOR
	...
	public static ConfiguredFeature<?, ?> ROCKY_PEAKS_BOULDER = register("rocky_peaks_boulder", VoyageFeatures.BIG_ROCK
			.withConfiguration(new BlockStateRadiusFeatureConfig(Blocks.COBBLESTONE.getDefaultState(), 1))
			.withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).func_242732_c(4));

	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> SUPER_BIRCH = register("super_birch", Feature.TREE
			.withConfiguration((new BaseTreeFeatureConfig.Builder(
					...
					new StraightTrunkPlacer(5, 2, 6), new TwoLayerFeature(1, 0, 1)))
				.setIgnoreVines()
				.build()));

	public static ConfiguredFeature<BaseTreeFeatureConfig, ?> SUPER_OAK = register("super_oak", Feature.TREE
			.withConfiguration((new BaseTreeFeatureConfig.Builder(
	...
	public static ConfiguredFeature<?, ?> LUSH_TREES = register("lush_trees", Feature.RANDOM_SELECTOR
			.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(
					SUPER_BIRCH_BEES_0002.withChance(0.01f), 
					SUPER_BIRCH.withChance(0.01f), 
					SUPER_OAK_BEES_0002.withChance(0.2f), 
					SUPER_OAK.withChance(0.78f)), 
					SUPER_OAK))
			.withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(15, 0.1F, 1))));
