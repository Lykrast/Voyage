package lykrast.voyage.biomebuilder;
...
public enum DefaultFeature {
  ...
  AQUATIC_STRUCTURES("aquatic_structures", (biome) -> {
         biome.withStructure(StructureFeatures.MINESHAFT);
         biome.withStructure(StructureFeatures.BURIED_TREASURE);
         biome.withStructure(StructureFeatures.SHIPWRECK_BEACHED);
  });
