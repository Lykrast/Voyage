...
public class DesertPolarBiome extends Biome {

	public DesertPolarBiome() {
		super((new Biome.Builder())
				.surfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(Blocks.SNOW_BLOCK.getDefaultState(), SurfaceBuilder.DIRT, SurfaceBuilder.GRAVEL))
				.precipitation(RainType.SNOW).category(Category.ICY)
				.depth(0.05F).scale(0.0F).temperature(0.0F).downfall(0.0F)
				.waterColor(ColorConstants.STANDARD_WATER).waterFogColor(ColorConstants.STANDARD_WATERFOG));
		//Adapted from Snowy Tundra
